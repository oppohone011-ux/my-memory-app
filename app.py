...
# --- 0. 画面設定（ここで折り畳みとGitHub隠しを設定） ---
st.set_page_config(
    page_title="みんなの思い出帳",
    layout="centered",      
    initial_sidebar_state="collapsed" # ★左側のメニューを最初から閉じておく設定
)

# 右上のGitHubリンクやメニューを完全に消すCSS
...
if check_auth(db):
    ...
    with st.container():
        ...
        with st.form("add_form", clear_on_submit=True):
            ...
            # uploaded_file = st.file_uploader("写真", type=["jpg", "png", "jpeg"]) # 写真機能は今後実装
